...
gen_list = ["Female", "Male"] #ask for gender
edu_list = ["Bachelor's", "Master's", "PhD"] #ask for education level
job_list = ["Director of Marketing", "Director of Operations", "Senior Data Scientist", "Senior Financial Analyst", "Senior Software Engineer"] #ask for job
